...
<div class="day container day_10"  id="day_10">
	<a href="javascript:void(0)" onclick="share(this);gaTrack('home','click','share_10',10);" data-url="<?php echo $GLOBALS['url']; ?>10" class="btn btn_comparte">
		<img src="img/comparte.png">	
	</a>
	<a href="javascript:void(0)" onclick="play_video('churro', 10);" class="btn btn_video">
